...
const start = (args) => {
    ...
    polka()
        ...
        .post('/nuevoMensaje', (req, res) => {
            ...
            console.log(msg);
            console.log(tipoServicio)// Imprimimos el valor del campo "msg"
            // Guardado de datos
        ...
        .post('/editarMensaje', (req, res) => {
            ...
            console.log(req.body.idMensaje)
            ...
            readFile(datosServicios, (err, data) => {
                ...
                require$$1.writeFile(datosServicios, JSON.stringify(obj), err => {
                    if(err) throw err;
                    console.log('Se edito el mensaje ' + req.body.mensaje + ' en ' + tipoServicio)
