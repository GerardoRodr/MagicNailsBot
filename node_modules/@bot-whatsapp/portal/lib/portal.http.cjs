...
const start = (args) => {
    ...
    const banner = () => {
        ...
        console.log(cyan(`Para gestionar las PROMOCIONES puedes ingresar a `), yellow(`${publicSite}:${port}/promociones`));
        console.log(cyan(`Para gestionar los SERVICIOS puedes ingresar a `), yellow(`${publicSite}:${port}/servicios`));
    };
    ...
    polka()
        ...
        .get('/promociones', (_, res) => {
            // Manejar la solicitud para la página principal
            res.setHeader('Content-Type', 'text/html');
            const fileStream = createReadStream('./resources/promociones/gestorProm.html');
            fileStream.pipe(res);
        })
        .get('/servicios', (_, res) => {
            // Manejar la solicitud para la página principal
            res.setHeader('Content-Type', 'text/html');
            const fileStream = createReadStream('./resources/servicios/gestorServicios.html');
            fileStream.pipe(res);
        })
        .listen(port, () => banner());
};
