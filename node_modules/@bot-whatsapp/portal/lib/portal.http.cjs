...
const start = (args) => {
    ...
    polka()
        ...
        .use(cookieSession({
            ...
            httpOnly: true, // Evita el acceso a la cookie desde JavaScript en el navegador *DEBE IR EN TRUE EN PRODUCCION"
            secure: true, // Solo se enviará la cookie a través de HTTPS *DEBE IR EN TRUE EN PRODUCCION"
