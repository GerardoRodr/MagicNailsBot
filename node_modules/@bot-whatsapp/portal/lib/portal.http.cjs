...
const start = (args) => {
    ...
    const storageServicios = multer.diskStorage({
        destination: function (req, file, cb) {
          cb(null, './resources/servicios/imgs');
        },
    ...
    const storagePromociones = multer.diskStorage({
        destination: function (req, file, cb) {
          cb(null, './resources/promociones/imgs');
        },
        filename: function (req, file, cb) {
          cb(null, Date.now() + require$$0.extname(file.originalname));
        }
      });
    const uploadPromociones = multer({ storage: storagePromociones }); 
    ...
    polka()
        ...
        .post('/subirImagenServicios', uploadServicios.single('img'), function(req, res) {
