...
const start = (args) => {
    ...
    polka()
        ...
        .post('/nuevoMensaje', (req, res) => {
            ...
            let datos
                if(categoria === "Servicios") {
                    datos = require$$0.resolve(__dirname, '../../../../resources/dataServicios.json')
                } else {
                    datos = require$$0.resolve(__dirname, '../../../../resources/dataPromociones.json')
                    isServicio = false;
                }
        ...
        .post('/editarMensajeImg', (req, res) => {
            ...
            let datos
                if(categoria === "Servicios") {
                    //require$$0.resolve(__dirname, '../../../../resources/dataServicios.json')
                    datos = require$$0.resolve(__dirname, '../../../../resources/dataServicios.json')
                } else {
                    datos = require$$0.resolve(__dirname, '../../../../resources/dataPromociones.json')
                    isServicio = false;
        ...
        .post('/subirImagen', (req, res) => {
            ...
            const storage = multer.diskStorage({
                destination: function (req, file, cb) {
                    //require$$0.resolve(__dirname, `../../../../${cat}/imgs/`)
                    cb(null, require$$0.resolve(__dirname, `../../../../resources/${cat}/imgs/`) + "\\" + tipoServicio);
                },
