...
const start = (args) => {
    ...
    polka()
        //.use(serve) ELIMINADO SERVE PARA DAR PASO A LA PAGINA PRINCIPAL CON METODO GET
        .use(bodyParser.urlencoded({ extended: true }))
        .use(cookieSession({
            name: 'session',
            keys: ['my-secret'],
            maxAge: 14 * 24 * 60 * 60 * 1000, // 2 semanas en milisegundos
            expires: new Date(Date.now() + (14 * 24 * 60 * 60 * 1000)), // Expira en 2 semanas
            httpOnly: false,
            secure: false,
            sameSite: 'strict' // Evita que la cookie se envíe en solicitudes cross-site
        }))
        .get('/', (req, res) => {
            ...
            if (isAuth === true) {
                res.statusCode = 302;
                let urlServicio = '/inicio'
                res.setHeader('Location', urlServicio);
                res.end();
            } else {
                res.setHeader('Content-Type', 'text/html');
                const fileStream = createReadStream('./node_modules/@bot-whatsapp/portal/dist/index.html');
                fileStream.pipe(res);
            }
        })
        ...
        .get('/inicio', (req, res) => {
            ...
            if (isAuth === true) {
                res.setHeader('Content-Type', 'text/html');
                const fileStream = createReadStream('./node_modules/@bot-whatsapp/portal/dist/inicio.html');
                fileStream.pipe(res);
            } else {
                res.statusCode = 302;
                let urlServicio = '/'
        ...
        .get('/promociones/alisado', (req, res) => {
            const isAuth = req.session.authenticated;
        ...
        .get('/promociones/mechas', (req, res) => {
            const isAuth = req.session.authenticated;
        ...
        .get('/promociones/manicure', (req, res) => {
            const isAuth = req.session.authenticated;
        ...
        .get('/promociones/maquillaje', (req, res) => {
            const isAuth = req.session.authenticated;

            if (isAuth === true) {
                res.setHeader('Content-Type', 'text/html');
                const fileStream = createReadStream('./resources/promociones/promoMaquillaje.html');
                fileStream.pipe(res);
            } else {
                res.statusCode = 302;
                let urlServicio = '/'
        ...
        .get('/promociones/cejaspes', (req, res) => {
            const isAuth = req.session.authenticated;

            if (isAuth === true) {
                res.setHeader('Content-Type', 'text/html');
                const fileStream = createReadStream('./resources/promociones/promoCejaspes.html');
                fileStream.pipe(res);
            } else {
                res.statusCode = 302;
                let urlServicio = '/'
        ...
        .get('/promociones/pedicure', (req, res) => {
            const isAuth = req.session.authenticated;

            if (isAuth === true) {
                res.setHeader('Content-Type', 'text/html');
                const fileStream = createReadStream('./resources/promociones/promoPedicure.html');
                fileStream.pipe(res);
            } else {
                res.statusCode = 302;
                let urlServicio = '/'
        ...
        .get('/promociones/depilaciones', (req, res) => {
            const isAuth = req.session.authenticated;

            if (isAuth === true) {
                res.setHeader('Content-Type', 'text/html');
                const fileStream = createReadStream('./resources/promociones/promoDepilaciones.html');
                fileStream.pipe(res);
            } else {
                res.statusCode = 302;
                let urlServicio = '/'
        ...
        .get('/promociones/limpiezafacial', (req, res) => {
            const isAuth = req.session.authenticated;

            if (isAuth === true) {
                res.setHeader('Content-Type', 'text/html');
                const fileStream = createReadStream('./resources/promociones/promoLimpiezafacial.html');
                fileStream.pipe(res);
            } else {
                res.statusCode = 302;
                let urlServicio = '/'
        ...
        .get('/promociones/tratamcapil', (req, res) => {
            const isAuth = req.session.authenticated;

            if (isAuth === true) {
                res.setHeader('Content-Type', 'text/html');
                const fileStream = createReadStream('./resources/promociones/promoTratamcapil.html');
                fileStream.pipe(res);
            } else {
                res.statusCode = 302;
                let urlServicio = '/'
        ...
        .get('/promociones/otros', (req, res) => {
            const isAuth = req.session.authenticated;

            if (isAuth === true) {
                res.setHeader('Content-Type', 'text/html');
                const fileStream = createReadStream('./resources/promociones/promoOtros.html');
                fileStream.pipe(res);
            } else {
                res.statusCode = 302;
                let urlServicio = '/'
        ...
        .get('/servicios/manicure', (req, res) => {
            const isAuth = req.session.authenticated;
        ...
        .get('/servicios/maquillaje', (req, res) => {
            const isAuth = req.session.authenticated;
        ...
        .get('/servicios/cejaspes', (req, res) => {
            const isAuth = req.session.authenticated;
        ...
        .get('/servicios/pedicure', (req, res) => {
            const isAuth = req.session.authenticated;
        ...
        .get('/servicios/depilaciones', (req, res) => {
            const isAuth = req.session.authenticated;
        ...
        .get('/servicios/limpiezafacial', (req, res) => {
            const isAuth = req.session.authenticated;
        ...
        .get('/servicios/tratamcapil', (req, res) => {
            const isAuth = req.session.authenticated;
        ...
        .get('/nuevoMensajeImagen', (req, res) => {
            const isAuth = req.session.authenticated;
        ...
        .post('/editarMensajeImg', async (req, res) => {
            ...
            let datos
                ...
                const data = readFileSync(datos);
                const obj = JSON.parse(data);
                const msg = obj[tipoServicio][idMensaje].mensaje;
                const path = join(process.cwd(), msg);
                const nombreArchivo = require$$0.basename(msg);
            
                if (typeof path === 'string' && path.match(/\.(jpeg|jpg|gif|png)$/) !== null) {
                    try {
                        require$$1.unlinkSync(path);
                ...
                const uploadImage = (req, res, categoria, tipoServicio, nombreArchivo) => {
                    return new Promise((resolve, reject) => {
                        // FUNCION PARA VOLVER A SUBIR LA IMAGEN
                        const storage = multer.diskStorage({
                            destination: function (req, file, cb) {
                                cb(null, `./resources/${categoria}/imgs/` + tipoServicio);
                            },
                        ...
                        upload.single('img')(req, res, function (err) {
                            if (err instanceof multer.MulterError) {
                                ...
                                console.log(`Se resubió la imagen ${req.file.filename} en la ruta: /resources/${cat}/imgs/${tipoServicio}`);
                ...
                try {
                    await uploadImage(req, res, cat, tipoServicio, nombreArchivo);
                    if (isServicio === true) {
                      res.statusCode = 302;
                      let urlServicio = '/servicios/' + tipoServicio;
                      res.setHeader('Location', urlServicio);
        ...
        .post('/subirImagen', async (req, res) => {
            const tipoServicio = req.query.tipoServicio
            const categoria = req.query.categoria;
            let isServicio = true;
            ...
            const storage = multer.diskStorage({
                destination: function (req, file, cb) {
                    //join(process.cwd(), `/resources/${cat}/imgs/`)
                    cb(null, join(__dirname, '..', '..', '..', '..', 'resources', cat, 'imgs', tipoServicio));
                    console.log(__dirname)
                    console.log(process.cwd())
                    console.log(join(__dirname, '..', '..', '..', '..', 'resources', cat, 'imgs', tipoServicio))
                },
                ...
                await new Promise((resolve, reject) => {
                    upload.single('img')(req, res, function (err) {
                        if (err instanceof multer.MulterError) {
                            ...
                            // La imagen se subió correctamente
                            console.log(`Se subió la imagen ${req.file.filename} en la ruta: /resources/${cat}/imgs/${tipoServicio}`);
        ...
        .post('/login', (req, res) => {
            ...
            if (username === 'administrador' && password === 'magic_administrador_') {
                // Establecer la variable de sesión como autenticada
