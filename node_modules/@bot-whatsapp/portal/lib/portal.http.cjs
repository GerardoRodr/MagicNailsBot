...
const start = (args) => {
    ...
    polka()
        ...
        .use(cookieSession({
            ...
            httpOnly: false, // Evita el acceso a la cookie desde JavaScript en el navegador *DEBE IR EN TRUE CUANDO DESPLIGUE"
            secure: false, // Solo se enviará la cookie a través de HTTPS *DEBE IR EN TRUE CUANDO DESPLIGUE"
